var helpView = {
    ...
    renderHelp: function(){
        var node = div().id('about-wrapper').cls('round10').app(
            ...
            p('Azokat nevezzük aktív kártyákat, melyek közül Leitner módszer szerinti gyakorlás esetén választhat a program. Ezek az első dobozban lévők, és a magasabb számú dobozokból azok, melyeket az adott dobozhoz tartozó időszaknál (lásd fenti táblázat) régebben gyakoroltunk.'),
